document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (minLength && !validators.minLength(value, minLength)) {
        const msg = typeof errorMessages.minLength === 'function'
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            ...
            const successMessage = contactForm.querySelector('.form-success') || createFormMessage('success');
        ...
        .catch(function () {
          const errorMessage = contactForm.querySelector('.form-error') || createFormMessage('error');
    ...
    function createFormMessage(type) {
  ...
  function initScrollAnimations() {
    const elements = document.querySelectorAll('.' + ANIMATE_CLASS + ', [data-animate]');
  ...
  const dynamicContentObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        if (node.matches && (node.matches('.' + ANIMATE_CLASS) || node.matches('[data-animate]'))) {
          initScrollAnimations();
        }

        const children = node.querySelectorAll && node.querySelectorAll('.' + ANIMATE_CLASS + ', [data-animate]');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2b10e347-bd58-4c3b-b176-7caaf555684d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2b10e347-bd58-4c3b-b176-7caaf555684d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2b10e347-bd58-4c3b-b176-7caaf555684d';
